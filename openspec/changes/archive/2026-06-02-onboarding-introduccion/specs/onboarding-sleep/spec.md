...
Cambio: `onboarding-introduccion` · slice 3 (Bloque 2 del mapa de bloques)
...
es responsabilidad del slice 5; este slice ONLY captura y guarda el consentimiento.
...
- AND no se pide ni se agenda ninguna notificación en este slice
...
en Room. MUST NOT introducir migración Room ni entidad nueva en este slice.

#### Scenario: Sin migración Room

- GIVEN el slice 3 aplicado
...
- Permiso `POST_NOTIFICATIONS` (Android 13+): se pide perezoso en slice 5, NUNCA en este slice.
- Scheduling/activación del recordatorio wind-down: slice 5.
- Notificación B (noches sin datos): slice 5.
